package uk.ac.qub.eeecs.gage.ai;
...
public class SteeringBehaviours {
	 ...
	 * 
	 * @param arrivingSprite
	 *            Arriving sprite
	 * @param targetPosition
	 *            Target position at which to arrive
	 * @param arriveAcceleration
	 *            Output arrive accleration
	 */
	 ...
	 * 
	 * @param aligningSprite
	 *            Sprite that should look at the target
	 * @param targetPosition
	 *            Location at which the sprite should look
	 ...
	 * 
	 * @param aligningSprite
	 *            Sprite whose orientation should be aligned.
	 ...
	 * 
	 * @param separatingSprite
	 *            Sprite that should be separated.
	 * @param targetSprites
	 *            Sprites to separate from.
	 * @param separateThreshold
	 *            Distance within which the sprite should separate.
	 * @param repulsionDecayFactor
	 *            How strongly should the sprite separate based on distance.
	 * @param outputAcceleration
	 *            Angular acceleration needed to seperate the sprite.
	 */
	 ...
	 *            Sprite that should be separated.
	 * @param targetSprite
	 *            Sprite to separate from.
	 * @param separateThreshold
	 *            Distance within which the sprite should separate.
	 * @param repulsionDecayFactor
	 *            How strongly should the sprite separate based on distance.
	 * @param outputAcceleration
	 *            Angular acceleration needed to separate the sprite.
	 */
