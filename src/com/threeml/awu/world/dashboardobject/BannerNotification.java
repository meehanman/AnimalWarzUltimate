 ...
 * 
 * @author Mary-Jane
 * Reference: http://stackoverflow.com/questions/1540272/android-how-to-overlay-a-bitmap-draw-over-a-bitmap
 */
public class BannerNotification extends OnScreenText{
	...
	private void createBannerBitmap(){
		mBannerImage = Bitmap.createBitmap((int)((mText.length() * mTextCellwidth) + (mTextCellwidth * 3)),
		...
		canvas.drawBitmap(mTextImage, (mBannerImage.getWidth() - mTextImage.getWidth()) / 2, (mBannerImage.getHeight() - mTextImage.getHeight()) / 2, paint);
	}
