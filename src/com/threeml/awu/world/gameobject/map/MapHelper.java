 ...
 * 
 * The Map Names to initialise the Maps are the imageName, a small and large image
 * must be placed in the TerrainImages/large and /small folder in assets
 * 
...
public class MapHelper {
	 ...
	 */
	private static String[] MapNames = {"Castles","FairyLand","Pirates","Ship","Titanic"};
	/**
