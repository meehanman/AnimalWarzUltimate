...
/**
 * 
 * Default Item class, other droppable items should inherit from this class
 * 
 * Extends Sprite
 * 
 */
public class Item extends Sprite {
	...
	/**
	 * If the item should still be active on screen i.e. an item is used up and
	 * is no longer needed
	 * **/
	 ...
	 */
	public Item(float startX, float startY, float width, float height,
