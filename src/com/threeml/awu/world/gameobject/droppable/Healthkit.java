...
/**
 * Healthkit object that falls from the top of the screen
 * When player picks it up, the player's health is increased
 * 		by the Health Value
 * 
 * Extends Item
 *
...
public class Healthkit extends Item{
	...
	/**
	 * @param healthValue
	 * 				Sets the health value the player will receive
	 * 				Health Value cannot be less than 0 or it will
	 * 				be set the default value of 0
	 * @param startX
